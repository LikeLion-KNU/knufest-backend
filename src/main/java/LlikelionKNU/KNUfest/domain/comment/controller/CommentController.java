...
public class CommentController {
    ...
    @Operation(summary = "추가 댓글 조회", description = "해당 부스의 추가 댓글내용을 제공한다. boothNum(부스 번호), categori(pub : 주점, comp : 복합, other: 기타)를 넘겨줘야 함. page = 요청 댓글 set 순번. deletable은 유저기반 삭제 가능 여부.")
    public ResponseEntity<List<Comment>> getExtraCommentPage(
        ...
        List<Comment> result = service.getCommentPage(boothNum, categori, page, userHash);
